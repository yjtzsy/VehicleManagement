...
$platform_ini = array(
	'../../nmi/db/DBSource.ini',
	'../../nmi/dbserver/DBSource.ini',
	PROJECT_DOMAIN_ROOT."/dbserver/mysql/DBSource.ini"
);

foreach ($platform_ini as $ini)
{
	if (file_exists($ini))
	{
		// ini常量，只能定义一次
		define('MYSQL_DB_SOURCEFILE_PATH', $ini);
		break;
	}
}
