...
class CR_Log
{
	...
	var $logFileName = "jiyuan"; // 日志文件名
	var $logFileMaxSize = 10485760; // 单文件最高大小（单位字节）
	var $logFileReserveDays = 2; // 日志文件最大保存天数
	...
	function CR_Log($logPath = "", $logFileName = "VehicleManager", $debug = true, $logLevel = null, $logFileMaxSize = 10485760)
	{
		try
		{
